...
#insteaed you can convert the set into a list  and access elements by index 
#list1=list(set1)
#print(list1[0])
...
#rint(tuple2.index('cherry')) #Output: 2
...
#age of coach, thirs player, location
...
#second budget of teh company 
print(company["departments"]["Engineering"]["budget"]) #Ouput:120000
